...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Trashed Suppliers'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.suppliers.trashed')); ?>" class="row g-3">
                <div class="col-md-6">
    ...
    <div class="card">
        <div class="card-body p-0">
            <?php if($suppliers->count() > 0): ?>
                <form id="bulkForm" method="POST" action="<?php echo e(route('admin.suppliers.bulk-restore')); ?>">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <?php endif; ?>
                                                <div>
                                                    <span class="fw-semibold text-muted"><?php echo e($supplier->name); ?></span>
                                        ...
                                        <td class="d-none d-md-table-cell">
                                            <span class="badge bg-light text-dark border opacity-60"><?php echo e($supplier->supplier_code); ?></span>
                                        </td>
                                        <td>
                                            <div class="small">
                                                <div><?php echo e($supplier->deleted_at->format('M d, Y')); ?></div>
                                                <small class="text-muted"><?php echo e($supplier->deleted_at->diffForHumans()); ?></small>
                                            </div>
                                        </td>
                                        <td class="text-end pe-4">
                                            <div class="btn-group">
                                                <form action="<?php echo e(route('admin.suppliers.restore', $supplier->id)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-danger"
                                                        onclick="confirmForceDelete(<?php echo e($supplier->id); ?>, '<?php echo e(addslashes($supplier->name)); ?>')" title="Delete Permanently">
                ...
                <div class="d-flex justify-content-between align-items-center px-4 py-3 border-top">
                    <div class="text-muted small">
                        Showing <?php echo e($suppliers->firstItem() ?? 0); ?> to <?php echo e($suppliers->lastItem() ?? 0); ?> of <?php echo e($suppliers->total()); ?> entries
                    </div>
                    <div>
                ...
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">
                        <?php if(request()->has('search')): ?>
                            No trashed suppliers match your search. <a href="<?php echo e(route('admin.suppliers.trashed')); ?>">Clear search</a>
                        <?php else: ?>
                            Deleted suppliers will appear here
                        <?php endif; ?>
                    </p>
                    <a href="<?php echo e(route('admin.suppliers.index')); ?>" class="btn btn-primary">
...
function bulkRestore() {
    if (confirm('Are you sure you want to restore selected suppliers?')) {
        $('#bulkForm').attr('action', '<?php echo e(route('admin.suppliers.bulk-restore')); ?>').submit();
    }
}

function bulkForceDelete() {
    if (confirm('Are you sure you want to permanently delete selected suppliers? This cannot be undone!')) {
        $('#bulkForm').attr('action', '<?php echo e(route('admin.suppliers.bulk-force-delete')); ?>')
            .attr('method', 'POST')
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\suppliers\trashed.blade.php ENDPATH**/ ?>