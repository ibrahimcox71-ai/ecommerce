...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Edit User'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1">Edit User: <?php echo e($user->name); ?></h4>
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input type="checkbox" name="status" class="form-check-input" id="status" value="1"
                                <?php echo e(old('status', $user->status) ? 'checked' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\users\edit.blade.php ENDPATH**/ ?>