...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Add Product'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Create a new product in your catalog</p>
        </div>
        <div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.product.type-selector','data' => ['selected' => ''.e(old('product_type', 'simple')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['selected' => ''.e(old('product_type', 'simple')).'']); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       id="sku" name="sku" value="<?php echo e(old('sku')); ?>" placeholder="Auto-generated">
                                <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      placeholder="Brief summary for product cards"><?php echo e(old('short_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                           id="cost_price" name="cost_price" value="<?php echo e(old('cost_price', 0)); ?>"
                                           step="0.01" min="0">
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                           id="tax" name="tax" value="<?php echo e(old('tax', 0)); ?>"
                                           step="0.01" min="0" max="100">
                                    <select class="form-select" name="tax_type" style="max-width:130px;">
                                        <option value="exclusive" <?php echo e(old('tax_type') === 'exclusive' ? 'selected' : ''); ?>>Exclusive</option>
                                        <option value="inclusive" <?php echo e(old('tax_type') === 'inclusive' ? 'selected' : ''); ?>>Inclusive</option>
                                    </select>
                                </div>
                                <?php $__errorArgs = ['tax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>"
                                           id="discount" name="discount" value="<?php echo e(old('discount', 0)); ?>"
                                           step="0.01" min="0">
                                    <select class="form-select" name="discount_type" style="max-width:100px;">
                                        <option value="percentage" <?php echo e(old('discount_type', 'percentage') === 'percentage' ? 'selected' : ''); ?>>%</option>
                                        <option value="fixed" <?php echo e(old('discount_type') === 'fixed' ? 'selected' : ''); ?>><?php echo e(config('ecommerce.currency_symbol')); ?></option>
                                    </select>
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                       id="discount_start" name="discount_start" value="<?php echo e(old('discount_start')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                       id="discount_end" name="discount_end" value="<?php echo e(old('discount_end')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.product.profit-calculator','data' => ['price' => old('price', 0),'costPrice' => old('cost_price', 0),'tax' => old('tax', 0),'taxType' => old('tax_type', 'exclusive'),'discount' => old('discount', 0),'discountType' => old('discount_type', 'percentage')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['price' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('price', 0)),'cost-price' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('cost_price', 0)),'tax' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('tax', 0)),'tax-type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('tax_type', 'exclusive')),'discount' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('discount', 0)),'discount-type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('discount_type', 'percentage'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('low_stock_threshold', 10)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('min_stock', 0)); ?>" min="0">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="unlimited_stock"
                                           name="unlimited_stock" value="1" <?php echo e(old('unlimited_stock') ? 'checked' : ''); ?>>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.product.dropzone','data' => ['name' => 'gallery','label' => 'Drop images here or click to upload','existing' => []]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'gallery','label' => 'Drop images here or click to upload','existing' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <div class="text-muted small mt-2" id="noVariantsMsg">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <small class="text-muted"><span id="metaTitleCount">0</span>/255 characters</small>
...
unset($__errorArgs, $__bag); ?>"
                                          ...
                                          maxlength="500" placeholder="SEO description"><?php echo e(old('meta_description')); ?></textarea>
                                <small class="text-muted"><span id="metaDescCount">0</span>/500 characters</small>
...
unset($__errorArgs, $__bag); ?>"
                                          id="schema_markup" name="schema_markup" rows="3"
                                           placeholder='{"@context":"https://schema.org/"}'><?php echo e(old('schema_markup')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status">
                                ...
                                <option value="active" <?php echo e(old('status') === 'active' ? 'selected' : ''); ?>>Published</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" class="form-check-input" id="featured"
                                   name="featured" value="1" <?php echo e(old('featured') ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="featured">Featured Product</label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" class="form-check-input" id="trending"
                                   name="trending" value="1" <?php echo e(old('trending') ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="trending">Trending</label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" class="form-check-input" id="best_seller"
                                   name="best_seller" value="1" <?php echo e(old('best_seller') ? 'checked' : ''); ?>>
                        ...
                        <div class="form-check form-switch">
                            <input type="checkbox" class="form-check-input" id="is_new_arrival"
                                   name="is_new_arrival" value="1" <?php echo e(old('is_new_arrival') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                   id="tags_string" name="tags_string" value="<?php echo e(old('tags_string')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                       id="weight" name="weight" value="<?php echo e(old('weight')); ?>" step="0.01" min="0">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control" name="length" value="<?php echo e(old('length')); ?>" step="0.01" min="0">
                            </div>
                            <div class="col-4">
                                <label for="width" class="form-label">Width</label>
                                <input type="number" class="form-control" name="width" value="<?php echo e(old('width')); ?>" step="0.01" min="0">
                            </div>
                            <div class="col-4">
                                <label for="height" class="form-label">Height</label>
                                <input type="number" class="form-control" name="height" value="<?php echo e(old('height')); ?>" step="0.01" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-7">
                                ...
                                <select class="form-select" name="warranty_type">
                                    <option value="no_warranty" <?php echo e(old('warranty_type', 'no_warranty') === 'no_warranty' ? 'selected' : ''); ?>>No Warranty</option>
                                    <option value="manufacturer" <?php echo e(old('warranty_type') === 'manufacturer' ? 'selected' : ''); ?>>Manufacturer</option>
                                    <option value="seller" <?php echo e(old('warranty_type') === 'seller' ? 'selected' : ''); ?>>Seller</option>
                                </select>
                            </div>
                            <div class="col-5">
                                <label for="warranty_period" class="form-label">Period (months)</label>
                                <input type="number" class="form-control" name="warranty_period" value="<?php echo e(old('warranty_period')); ?>" min="1">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="is_virtual"
                                   name="is_virtual" value="1" <?php echo e(old('is_virtual') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                   id="download_link" name="download_link" value="<?php echo e(old('download_link')); ?>"
                        ...
                        <div class="row g-3">
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" name="min_order_quantity"
                                       value="<?php echo e(old('min_order_quantity', 1)); ?>" min="1">
                            </div>
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" name="max_order_quantity"
                                       value="<?php echo e(old('max_order_quantity')); ?>" min="1">
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (categorySelect) {
        categorySelect.addEventListener('change', function() {
            ...
            if (catId) {
                fetch('/admin/products/get-sub-categories/' + catId)
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\products\create.blade.php ENDPATH**/ ?>