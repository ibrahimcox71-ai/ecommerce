...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Create Expense'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            <form method="POST" action="<?php echo e(route('admin.finance.expenses.store')); ?>" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="expense_category_id" class="form-select <?php $__errorArgs = ['expense_category_id'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="tax_amount" class="form-control <?php $__errorArgs = ['tax_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tax_amount', 0)); ?>" step="0.01" min="0">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('expense_date', now()->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="payee" class="form-control <?php $__errorArgs = ['payee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('payee')); ?>" placeholder="Vendor/Supplier name">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="payment_method" class="form-select">
                            ...
                            <option value="mobile_banking" <?php echo e(old('payment_method') === 'mobile_banking' ? 'selected' : ''); ?>>Mobile Banking</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="chart_of_account_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($account->id); ?>" <?php echo e(old('chart_of_account_id') == $account->id ? 'selected' : ''); ?>><?php echo e($account->code); ?> - <?php echo e($account->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Receipt</label>
                        <input type="file" name="receipt" class="form-control <?php $__errorArgs = ['receipt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('description')); ?>" placeholder="Brief description">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\finance\expenses\create.blade.php ENDPATH**/ ?>