...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Edit Role'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1">Edit Role: <?php echo e(ucfirst($role->name)); ?></h4>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('name', $role->name)); ?>" required placeholder="e.g., editor"
                                   <?php if($role->name === 'super-admin'): ?> readonly <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php elseif(count($groupedPermissions) > 0): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\roles\edit.blade.php ENDPATH**/ ?>