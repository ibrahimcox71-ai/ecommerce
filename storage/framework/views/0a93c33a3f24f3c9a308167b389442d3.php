                    ...
                    <?php if($isGuest): ?>
                        <div class="checkout-section guest-section">
                            <div class="guest-info">
                                ...
                                <a href="<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(route('checkout'))); ?>" class="btn-guest-login">Sign in for faster checkout</a>
                            </div>
                        </div>
                    <?php endif; ?>
                                ...
                                <div class="saved-addresses">
                                    ...
                                    <div class="address-cards">
                                        <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="address-card <?php echo e($loop->first ? 'selected' : ''); ?>">
                                                <input type="radio" name="saved_address_id" value="<?php echo e($addr->id); ?>"
                                                       ...
                                                       data-line1="<?php echo e($addr->address_line1); ?>"
                                                       data-line2="<?php echo e($addr->address_line2); ?>"
                                                       data-city="<?php echo e($addr->city); ?>"
                                                       data-state="<?php echo e($addr->state); ?>"
                                                       data-zip="<?php echo e($addr->zip); ?>"
                                                       data-country="<?php echo e($addr->country); ?>"
                                                       <?php echo e($loop->first ? 'checked' : ''); ?>>
                                                <label for="addr_<?php echo e($addr->id); ?>" class="address-card-label">
                                                    <strong><?php echo e($addr->name); ?></strong>
                                                    <span><?php echo e($addr->getFullAddress()); ?></span>
                                                    <?php if($addr->phone): ?>
                    ...
                    <div class="checkout-section">
                        ...
                        <div class="section-body">
                            <div class="shipping-methods">
                                <?php $__currentLoopData = $shippingMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="shipping-method-card <?php echo e($key === 'standard' ? 'selected' : ''); ?>">
                                        <input type="radio" name="shipping_method" value="<?php echo e($key); ?>"
                                               id="ship_<?php echo e($key); ?>"
                                               class="shipping-radio"
                                               data-cost="<?php echo e($method['cost']); ?>"
                                               <?php echo e($key === 'standard' ? 'checked' : ''); ?>>
                                        <label for="ship_<?php echo e($key); ?>" class="shipping-label">
                                            <div class="shipping-left">
                                                <div class="shipping-icon">
                                                    <?php if($key === 'free'): ?> <i class="fas fa-leaf"></i>
                                                    <?php elseif($key === 'express'): ?> <i class="fas fa-rocket"></i>
                                                    <?php elseif($key === 'overnight'): ?> <i class="fas fa-bolt"></i>
                                                    <?php else: ?> <i class="fas fa-truck"></i>
                                                    <?php endif; ?>
                                                </div>
                                                <div>
                                                    <strong><?php echo e($method['label']); ?></strong>
                                                    <span class="shipping-estimate"><?php echo e($method['estimate']); ?></span>
                                                </div>
                                            </div>
                                            <div class="shipping-price">
                                                <?php if($method['cost'] > 0): ?>
                                                    $<?php echo e(number_format($method['cost'], 2)); ?>
                    ...
                    <div class="checkout-summary-sticky">
                        <div class="checkout-summary-card">
                            ...
                            <div class="summary-items">
                                <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="summary-item">
                                        <img src="<?php echo e($item->getProductImage() ?? 'https://placehold.co/50x50/f0f0f0/999?text=N'); ?>"
                                             alt="<?php echo e($item->getProductTitle()); ?>" class="summary-item-img">
                                        <div class="summary-item-info">
                                            <span class="summary-item-name"><?php echo e(Str::limit($item->product->name, 30)); ?></span>
                                            <?php if($item->variant): ?>
                                                <span class="summary-item-variant"><?php echo e($item->variant->getAttributesList()); ?></span>
                                            <?php endif; ?>
                                            <span class="summary-item-qty">Qty: <?php echo e($item->quantity); ?></span>
                                        </div>
                                        <span class="summary-item-price">$<?php echo e(number_format($item->subtotal, 2)); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            ...
                            <div class="summary-calc">
                                <div class="calc-row">
                                    <span>Subtotal</span>
                                    <span id="checkoutSubtotal">$<?php echo e(number_format($cart->subtotal, 2)); ?></span>
                                </div>
                                <?php if($cart->coupon_id): ?>
                                    <div class="calc-row text-success">
                                        <span>Coupon (<?php echo e($cart->coupon->code ?? ''); ?>)</span>
                                        <span id="checkoutDiscount">-$<?php echo e(number_format($cart->coupon_discount, 2)); ?></span>
                                    </div>
                                <?php endif; ?>
                                <div class="calc-row">
                                    <span>Shipping</span>
                                ...
                                <div class="calc-row">
                                    <span>Tax</span>
                                    <span id="checkoutTax">$<?php echo e(number_format($cart->tax_amount, 2)); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="calc-total">
                                <span>Total</span>
                                <span id="checkoutTotal">$<?php echo e(number_format($cart->total, 2)); ?></span>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateCheckoutShipping(cost) {
        ...
        const subtotal = parseFloat('<?php echo e($cart->subtotal); ?>');
        const discount = parseFloat('<?php echo e($cart->coupon_discount); ?>');
        const taxRate = parseFloat('<?php echo e($cart->tax_rate); ?>');
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\frontend\checkout.blade.php ENDPATH**/ ?>