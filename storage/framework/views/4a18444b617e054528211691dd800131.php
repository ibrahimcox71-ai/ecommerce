...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Stock Out'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Remove stock from inventory</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h6 class="fw-bold mb-0">Remove Stock</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('admin.inventories.stock-out.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   min="1" placeholder="Enter quantity to remove" required>
...
unset($__errorArgs, $__bag); ?>"
                                   id="reason" name="reason" value="<?php echo e(old('reason', 'Stock Out')); ?>"
                                   placeholder="e.g., Order fulfillment, Damage, Adjustment, etc.">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\inventories\stock-out.blade.php ENDPATH**/ ?>