...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Create Warehouse'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('admin.warehouses.store')); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="Enter warehouse name" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="code" name="code" value="<?php echo e(old('code')); ?>" placeholder="WH-01" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="manager_name" name="manager_name" value="<?php echo e(old('manager_name')); ?>" placeholder="Manager name">
...
unset($__errorArgs, $__bag); ?>"
                                      id="address" name="address" rows="2" placeholder="Street address"><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                           id="city" name="city" value="<?php echo e(old('city')); ?>" placeholder="City">
...
unset($__errorArgs, $__bag); ?>"
                                           id="state" name="state" value="<?php echo e(old('state')); ?>" placeholder="State">
...
unset($__errorArgs, $__bag); ?>"
                                           id="country" name="country" value="<?php echo e(old('country')); ?>" placeholder="Country">
...
unset($__errorArgs, $__bag); ?>"
                                           id="phone" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Phone number">
...
unset($__errorArgs, $__bag); ?>"
                                   id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="warehouse@example.com">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\warehouses\create.blade.php ENDPATH**/ ?>