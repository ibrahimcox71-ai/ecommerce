...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Create Order'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="input-group input-group-sm" style="width: 130px; margin-left: auto;">
                                            <input type="number" name="tax_rate" id="taxRate" class="form-control text-end" step="0.01" min="0" value="<?php echo e(config('ecommerce.tax_rate', 0)); ?>">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="shipping_address[name]" class="form-control" value="<?php echo e($selectedCustomer?->name ?? old('shipping_address.name')); ?>" id="shipName">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small fw-semibold">Email</label>
                            <input type="email" name="shipping_address[email]" class="form-control" value="<?php echo e($selectedCustomer?->email ?? old('shipping_address.email')); ?>" id="shipEmail">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small fw-semibold">Phone</label>
                            <input type="text" name="shipping_address[phone]" class="form-control" value="<?php echo e($selectedCustomer?->phone ?? old('shipping_address.phone')); ?>" id="shipPhone">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-semibold">Address Line 1</label>
                            <input type="text" name="shipping_address[address_line1]" class="form-control" value="<?php echo e(old('shipping_address.address_line1')); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-semibold">Address Line 2</label>
                            <input type="text" name="shipping_address[address_line2]" class="form-control" value="<?php echo e(old('shipping_address.address_line2')); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label small fw-semibold">City</label>
                            <input type="text" name="shipping_address[city]" class="form-control" value="<?php echo e(old('shipping_address.city')); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label small fw-semibold">State</label>
                            <input type="text" name="shipping_address[state]" class="form-control" value="<?php echo e(old('shipping_address.state')); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label small fw-semibold">ZIP</label>
                            <input type="text" name="shipping_address[zip]" class="form-control" value="<?php echo e(old('shipping_address.zip')); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label small fw-semibold">Country</label>
                            <input type="text" name="shipping_address[country]" class="form-control" value="<?php echo e(old('shipping_address.country', 'US')); ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <textarea name="notes" class="form-control" rows="3" placeholder="Internal notes..."><?php echo e(old('notes')); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-outline-secondary w-100 mt-2">Cancel</a>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\orders\create.blade.php ENDPATH**/ ?>