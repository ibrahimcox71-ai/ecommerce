    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="<?php echo e(route('home')); ?>" class="footer-brand" aria-label="<?php echo e(config('app.name')); ?> home">
                    <span class="footer-logo-icon"><i class="fas fa-store"></i></span>
                    <span class="footer-logo-text"><?php echo e(config('app.name')); ?></span>
                </a>
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo e(route('shop')); ?>">Shop All</a></li>
                    <li><a href="<?php echo e(route('flash-sale')); ?>">Flash Sale</a></li>
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. All rights reserved. Built with care.</p>
...
<?php /**PATH C:\laragon\www\ecommerce\resources\views\partials\frontend\footer.blade.php ENDPATH**/ ?>