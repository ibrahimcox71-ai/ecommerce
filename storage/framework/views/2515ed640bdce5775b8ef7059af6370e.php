...
<?php $component = App\View\Components\Layouts\AdminLayout::resolve(['title' => 'Order Reports'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.orders.reports.sales')); ?>" class="btn btn-sm btn-outline-primary mt-3 w-100">
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.orders.reports.daily')); ?>" class="btn btn-sm btn-outline-success mt-3 w-100">
                    <i class="fas fa-eye me-1"></i> View Report
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.orders.reports.monthly')); ?>" class="btn btn-sm btn-outline-info mt-3 w-100">
                    <i class="fas fa-eye me-1"></i> View Report
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.orders.reports.top-customers')); ?>" class="btn btn-sm btn-outline-warning mt-3 w-100">
                    <i class="fas fa-eye me-1"></i> View Report
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.orders.reports.top-products')); ?>" class="btn btn-sm btn-outline-danger mt-3 w-100">
                    <i class="fas fa-eye me-1"></i> View Report
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.orders.reports.cancelled')); ?>" class="btn btn-sm btn-outline-secondary mt-3 w-100">
                    <i class="fas fa-eye me-1"></i> View Report
                </a>
            </div>
        </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('admin.orders.reports.returned')); ?>" class="btn btn-sm btn-outline-warning mt-3 w-100">
                    <i class="fas fa-eye me-1"></i> View Report
                </a>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ecommerce\resources\views\admin\orders\reports\index.blade.php ENDPATH**/ ?>