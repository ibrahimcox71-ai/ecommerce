<x-layouts.admin-layout title="Add Product">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <x-admin.product.type-selector selected="{{ old('product_type', 'simple') }}" />
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('short_description') is-invalid @enderror"
                                      ...
                                      placeholder="Brief summary for product cards">{{ old('short_description') }}</textarea>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="discount_type" style="max-width:100px;">
                                        ...
                                        <option value="fixed" {{ old('discount_type') === 'fixed' ? 'selected' : '' }}>{{ config('ecommerce.currency_symbol') }}</option>
                                    </select>
                                </div>
                        ...
                        <div class="mt-3">
                            <x-admin.product.profit-calculator
                                :price="old('price', 0)"
                                :cost-price="old('cost_price', 0)"
                                :tax="old('tax', 0)"
                                :tax-type="old('tax_type', 'exclusive')"
                                :discount="old('discount', 0)"
                                :discount-type="old('discount_type', 'percentage')" />
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="unlimited_stock"
                                           name="unlimited_stock" value="1" {{ old('unlimited_stock') ? 'checked' : '' }}>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                          ...
                                          maxlength="500" placeholder="SEO description">{{ old('meta_description') }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" class="form-check-input" id="trending"
                                   name="trending" value="1" {{ old('trending') ? 'checked' : '' }}>
                            <label class="form-check-label" for="trending">Trending</label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            <input type="checkbox" class="form-check-input" id="best_seller"
                                   name="best_seller" value="1" {{ old('best_seller') ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tags') is-invalid @enderror"
                                   id="tags_string" name="tags_string" value="{{ old('tags_string') }}"
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control" name="length" value="{{ old('length') }}" step="0.01" min="0">
                            </div>
                            <div class="col-4">
                                <label for="width" class="form-label">Width</label>
                                <input type="number" class="form-control" name="width" value="{{ old('width') }}" step="0.01" min="0">
                            </div>
                            <div class="col-4">
                                <label for="height" class="form-label">Height</label>
                                <input type="number" class="form-control" name="height" value="{{ old('height') }}" step="0.01" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-7">
                                ...
                                <select class="form-select" name="warranty_type">
                                    <option value="no_warranty" {{ old('warranty_type', 'no_warranty') === 'no_warranty' ? 'selected' : '' }}>No Warranty</option>
                                    <option value="manufacturer" {{ old('warranty_type') === 'manufacturer' ? 'selected' : '' }}>Manufacturer</option>
                                    <option value="seller" {{ old('warranty_type') === 'seller' ? 'selected' : '' }}>Seller</option>
                                </select>
                            </div>
                            <div class="col-5">
                                <label for="warranty_period" class="form-label">Period (months)</label>
                                <input type="number" class="form-control" name="warranty_period" value="{{ old('warranty_period') }}" min="1">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="is_virtual"
                                   name="is_virtual" value="1" {{ old('is_virtual') ? 'checked' : '' }}>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" name="max_order_quantity"
                                       value="{{ old('max_order_quantity') }}" min="1">
                            </div>
                        </div>
                    </div>
                </div>
