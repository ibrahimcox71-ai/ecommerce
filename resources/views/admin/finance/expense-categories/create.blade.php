<x-layouts.admin-layout title="Create Expense Category">
            ...
            <form method="POST" action="{{ route('admin.finance.expense-categories.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="type" class="form-control @error('type') is-invalid @enderror" value="{{ old('type') }}" placeholder="e.g., Operational, Travel">
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input type="checkbox" name="is_active" class="form-check-input" value="1" @checked(old('is_active', true)) id="isActive">
